		...
		<div className="relative transition-transform duration-300 transform" ref={dropdownRef}>
			...
			>
				<div className="flex items-center">
					<span className="mr-2 capitalize font-bold">
						{contextModel ?? 'Select Model'}
					</span>
				</div>
				<FaChevronDown
					className={`w-3 h-3 mt-0.5 transition-transform text-black-500 dark:text-slate-300 ${isDropdownOpen ? 'rotate-180' : ''}`}
				/>
			</button>
