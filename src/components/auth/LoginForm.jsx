    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-2 bg-primary-100 dark:bg-black-800 text-slate-700 dark:text-white">Or continue with</span>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            />
            <label htmlFor="remember" className="ml-2 text-sm text-slate-700 dark:text-white">
              Remember me
            </label>
          </div>
          <a href="#" className="text-sm text-slate-500 dark:text-slate-200 hover:text-primary-300">
            Forgot password?
          </a>
        </div>
