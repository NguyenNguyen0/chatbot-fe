            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <label htmlFor="theme-light" className="text-gray-700 dark:text-gray-300">Light</label>
                </div>
                <div className="flex items-center space-x-2">
                  <input
                    type="radio"
                    ...
                    className="text-primary-600 focus:ring-primary-500"
                  />
                  <label htmlFor="theme-dark" className="text-gray-700 dark:text-gray-300">Dark</label>
                </div>
                <div className="flex items-center space-x-2">
                  <input
                    type="radio"
                    ...
                    className="text-primary-600 focus:ring-primary-500"
                  />
                  <label htmlFor="theme-system" className="text-gray-700 dark:text-gray-300">System</label>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-64 border-r border-gray-200 dark:border-gray-700 flex flex-col">
          ...
          <nav className="flex-1 p-4">
            ...
            <ul className="space-y-1">
              <li>
                <button
                  className={`w-full text-left px-4 py-2 rounded-lg ${activeSection === 'profile'
              ...
              <li>
                <button
                  className={`w-full text-left px-4 py-2 rounded-lg ${activeSection === 'appearance'
                      ? 'bg-primary-100 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400'
                      : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700'
                    }`}
              ...
              <li>
                <button
                  className={`w-full text-left px-4 py-2 rounded-lg ${activeSection === 'notifications'
                      ? 'bg-primary-100 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400'
                      : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700'
                    }`}
