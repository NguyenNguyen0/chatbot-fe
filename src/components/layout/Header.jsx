...
function Header({ className }) {
	return (
		<header
			className={`"app-header relative px-6 py-8 md:px-12 bg-gradient-to-r from-primary-200 to-primary-300  dark:from-black-700 dark:to-black-600 shadow-2xl" ${className}`}
		>
			<Nav />
			...
			<div className="mt-20 md:mt-32 mb-32 text-center">
				...
				<p className="text-white text-lg md:text-xl max-w-2xl mx-auto mb-8">
					Experience the power of AI-driven conversations. Get instant answers, creative
