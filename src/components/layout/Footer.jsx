					...
					<div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
						<div className="col-span-1">
							...
							<p className="md:text-left text-center text-slate-100 dark:text-white">
								Your intelligent companion for smarter conversations and creative
								solutions.
							</p>
						</div>
						<div className="col-span-1">
							<h3 className="md:text-left text-center text-primary-600 dark:text-primary-300 font-semibold mb-4">
								Quick Links
							</h3>
					...
					<div className="border-t border-slate-100 dark:border-black-700 pt-8">
						<div className="flex flex-col md:flex-row justify-between items-center">
							...
							<p className="text-slate-100 dark:text-white text-sm flex items-center">
								Made with
								<span className="text-primary-600 dark:text-primary-400 mx-1">
									♥
								</span>
								by
								<a
