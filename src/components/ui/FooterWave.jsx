...
function FooterWave({ theme }) {
	...
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1600 198" preserveAspectRatio="none">
			<defs>
				<linearGradient id="gradient-dark" x1="50%" x2="50%" y1="-10.959%" y2="100%">
					<stop
						stopColor="var(--color-black-700, #1c1618)"
						stopOpacity=".80"
						offset="0%"
					/>
				...
				<linearGradient id="gradient-light" x1="50%" x2="50%" y1="-10.959%" y2="100%">
					<stop
						stopColor="var(--color-primary-300, #6366f1)"
						stopOpacity=".80"
						offset="0%"
					/>
