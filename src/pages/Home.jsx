...
function Home() {
  ...
  return (
    <Background>
      ...
      <section className="px-6 py-20 md:px-12 bg-black-800/50">
      ...
      <section className="px-6 py-20 md:px-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-black-800/50 rounded-2xl p-6 mb-8">
            <div className="chat-demo-messages mb-4 h-64 overflow-y-auto custom-scrollbar">
              <div className="flex items-start mb-4">
                ...
                <div className="bg-black-700 rounded-lg p-4 text-white">
              ...
              {demoMessage && (
                <>
                  <div className="flex items-start mb-4 justify-end">
                    <div className="bg-primary-500/20 rounded-lg p-4 text-white">
                      {demoMessage}
                    </div>
      ...
      <section className="px-6 py-20 md:px-12 bg-black-800/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-black-700/50 rounded-xl p-8 border border-primary-400/20">
              <div className="flex items-center mb-6">
                ...
                />
                <div className="ml-4">
                  <p className="text-white font-semibold">Anand Viswanathan</p>
                  <p className="text-slate-200 text-sm">Marketing Manager</p>
                </div>
              </div>
            ...
            <div className="bg-black-700/50 rounded-xl p-8 border border-primary-400/20">
              <div className="flex items-center mb-6">
                ...
                />
                <div className="ml-4">
                  <p className="text-white font-semibold">Emma Blue</p>
                  <p className="text-slate-200 text-sm">English Student</p>
                </div>
              </div>
              <FaRegComments className="w-8 h-8 text-primary-400 mb-4" />
              <p className="text-white mb-6 text-lg">
