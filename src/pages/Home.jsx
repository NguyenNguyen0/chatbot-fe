          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="backdrop-blur-3xl bg-white/40 dark:bg-black-700/50 rounded-xl p-8 border border-primary-400/20 shadow-lg">
              <div className="flex items-center mb-6">
                ...
                />
                <div className="ml-4">
                  <p className="text-gray-800 dark:text-white font-semibold">Anand Viswanathan</p>
                  <p className="text-gray-600 dark:text-slate-200 text-sm">Marketing Manager</p>
                </div>
              </div>
            ...
            <div className="backdrop-blur-3xl bg-white/40 dark:bg-black-700/50 rounded-xl p-8 border border-primary-400/20 shadow-lg">
              <div className="flex items-center mb-6">
                ...
                />
                <div className="ml-4">
                  <p className="text-gray-800 dark:text-white font-semibold">Emma Blue</p>
                  <p className="text-gray-600 dark:text-slate-200 text-sm">English Student</p>
                </div>
              </div>
              <FaRegComments className="w-8 h-8 text-primary-400 mb-4" />
              <p className="text-gray-800 dark:text-white mb-6 text-lg">
