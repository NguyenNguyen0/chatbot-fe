	...
	const features = [
		{
			...
			description:
				'Experience natural conversations with our advanced AI that understands context and provides intelligent responses.',
		},
		{
			icon: <HiMagnifyingGlass className="w-12 h-12" />,
			title: 'Smart Search & History',
			description:
				'Easily search through your chat history and find previous conversations with our powerful search functionality.',
		},
		{
			icon: <LiaUser className="w-12 h-12" />,
			title: 'Personalized Experience',
			description:
				'Get tailored responses based on your preferences and conversation history.',
		},
	];
				...
				<div className="container mx-auto px-4 py-16">
					<div className="text-center mb-16">
						...
						<p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
							Discover the advanced capabilities of our AI chatbot designed to enhance
					...
					<div className="space-y-20">
						<div className="flex flex-col md:flex-row items-center gap-8">
							<div className="flex-1">
								...
								<p className="text-gray-600 dark:text-gray-300 mb-4">
									Our advanced NLP algorithms understand context and nuance,
									making conversations feel natural and intuitive.
								</p>
						...
						<div className="flex flex-col md:flex-row-reverse items-center gap-8">
							<div className="flex-1">
								...
								<p className="text-gray-600 dark:text-gray-300 mb-4">
									Our AI continuously learns from interactions to provide better
									and more personalized responses over time.
								</p>
								<ul className="space-y-2">
									{[
